...
export class MainScene extends g.Scene {
	...
	constructor(param: g.SceneParameterObject) {
		param.assetIds = [
			...
			"enemy", "waku","shot","eshot","wall","ufo","player","effect","wakuf","clear",
			"config", "volume", "test", "glyph72", "number_w", "number_b", "number_p",
			"se_start", "se_timeup", "bgm", "se_clear", "se_move", "se_up", "se_finish", "se_zen", "se_shot", "se_miss", "se_ufo"];
		super(param);
		...
		this.loaded.add(() => {
			...
			//ステージ
			uiBase.append(new g.Sprite({ scene: this, src: this.assets["score"], x: 505, y: 45, height: 32, srcY: 32 }));
			let stage = 0;
			...
			//スコア
			uiBase.append(new g.Sprite({ scene: this, src: this.assets["score"], x: 505, y: 85, height: 32 }));
			let score = 0;
